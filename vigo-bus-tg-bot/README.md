...
A Helm chart for deploying the vigo bus telegram bot on Kubernetes
...
| apiUrl | string | `"core-vigo-bus-core"` |  |
| botToken | string | `""` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"ghcr.io/eryalito/vigo-bus-tg-bot"` |  |
| image.tag | string | `""` |  |
